...
//read the file if file name is same as user input :
...
public class Main {
    public static void main(String[] args) {
        ...
        String fileName = scanner.nextLine().trim(); // Trim to remove leading/trailing spaces
        scanner.close();

        // Check if the provided file name matches the actual file name
        if (!fileName.equals("exam.txt")) {
